...
const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Task detail drawer', detail: 'Click the arrow icon on a task card to open the full detail panel as a drawer — edit all fields, manage relations, notes, and subtasks without leaving Emperor Time.' },
  ...
  },
  {
    ...
    items: [
      { label: 'Command', detail: '**Focus** (daily priorities, protocols), **Dashboard** (overview with workspace filter), **Emperor Time** (deep work), **Review** (weekly review).' },
