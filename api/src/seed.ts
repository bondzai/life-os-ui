...
const entityData = [
  ...
  { id: 'goal-3', type: 'goal', title: 'Launch Life-OS', description: 'Complete all 10 phases of the Life-OS project.', status: 'active', priority: 'urgent', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({ progress: 15 }), ownerId: 'user-jb', visibility: 'private', dueDate: '2026-09-30', createdAt: now, updatedAt: now },
  ...
  { id: 'goal-3a', type: 'goal', title: 'Complete Phase 1 — Foundation', description: 'Scaffold, core engine, layout, auth, seed data.', status: 'completed', priority: 'urgent', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({ progress: 100 }), parentId: 'goal-3', ownerId: 'user-jb', visibility: 'private', createdAt: now, updatedAt: now },
  { id: 'goal-3b', type: 'goal', title: 'Complete Phase 2 — Plan', description: 'Goals, tasks, calendar modules.', status: 'active', priority: 'urgent', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({ progress: 0 }), parentId: 'goal-3', ownerId: 'user-jb', visibility: 'private', createdAt: now, updatedAt: now },

  // Tasks
  { id: 'task-1', type: 'task', title: 'Set up Life-OS dashboard', description: 'Complete Phase 1 foundation implementation.', status: 'completed', priority: 'urgent', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({}), ownerId: 'user-jb', visibility: 'private', dueDate: yesterday, createdAt: now, updatedAt: now },
  ...
  { id: 'task-3', type: 'task', title: 'Implement goals page', description: 'Build the goals module with CRUD, sub-goals, and progress tracking.', status: 'active', priority: 'high', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({}), ownerId: 'user-jb', visibility: 'private', dueDate: today, createdAt: now, updatedAt: now },
  { id: 'task-4', type: 'task', title: 'Implement tasks page', description: 'Build the tasks module with list and kanban views.', status: 'active', priority: 'high', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({}), ownerId: 'user-jb', visibility: 'private', dueDate: tomorrow, createdAt: now, updatedAt: now },
  ...
  // Notes
  { id: 'note-1', type: 'note', title: 'Life-OS Architecture Notes', description: 'Key decisions and patterns for the Life-OS project.', status: 'active', priority: 'medium', tags: JSON.stringify(['dev', 'life-os']), metadata: JSON.stringify({ body: 'Entity-driven architecture with DRY core engine. All modules reuse the same CRUD hooks and dialog patterns. Zustand for client state, TanStack Query for data sync.', isJournal: false }), ownerId: 'user-jb', visibility: 'private', createdAt: now, updatedAt: now },
  { id: 'note-2', type: 'note', title: 'Morning reflection', status: 'active', priority: 'low', tags: JSON.stringify(['journal']), metadata: JSON.stringify({ body: 'Feeling productive today. Made good progress on Life-OS Phase 4.5. The notification system and map integration are coming together nicely.', isJournal: true, date: today, mood: 'happy' }), ownerId: 'user-jb', visibility: 'private', createdAt: now, updatedAt: now },
  ...
  // Devices
  { id: 'device-1', type: 'device', title: 'Mini PC (Home Server)', description: 'Main home server running Life-OS, OpenClaw, and Docker.', status: 'active', priority: 'high', tags: JSON.stringify(['server', 'docker']), metadata: JSON.stringify({ deviceType: 'server', ip: '192.168.1.100', os: 'Ubuntu 24.04 LTS', location: 'Living room' }), ownerId: 'user-jb', visibility: 'shared', createdAt: now, updatedAt: now },
  ...
  // Services
  { id: 'service-1', type: 'service', title: 'Life-OS API', status: 'active', priority: 'high', tags: JSON.stringify(['api', 'life-os']), metadata: JSON.stringify({ serviceType: 'api', serviceStatus: 'running', url: 'http://192.168.1.100:3000', port: 3000, deviceId: 'device-1', image: 'life-os-api:latest' }), ownerId: 'user-jb', visibility: 'shared', createdAt: now, updatedAt: now },
